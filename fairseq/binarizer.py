...
from fairseq.tokenizer import tokenize_line, tokenize_line_by_wordpiece
            ...
            while line:
                ...
                if line != '':
                    if already_numberized:
                        ...
                        if char_tokenize:
                            line_tokenizer = lambda l, vocab: [ch for ch in l]
                        elif wordpiece_tokenize:
                            line_tokenizer = tokenize_line_by_wordpiece
                        else:
