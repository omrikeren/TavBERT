...
class MaskedLMTask(LegacyFairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--poisson-lambda', default=7, type=int,
                            help='the parameter of the Poisson dostribution from which the lengths of the masked spans '
                                 'are samples')
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        src_dataset, tgt_dataset = MaskTokensDataset.apply_mask(
            ...
            poisson_lambda=self.args.poisson_lambda
        )
