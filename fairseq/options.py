...
def add_preprocess_args(parser):
    ...
    group.add_argument("--char-tokenize", action='store_true', default=False,
                       help="Whether or not to tokenize input by characters")
    group.add_argument("--wordpiece-tokenize", action="store_true", default=False,
                       help="Whether or not to tokenize input by word piece")
    # fmt: on
    return parser
